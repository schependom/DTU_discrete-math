...
> [!exercise] Identity element of the quotient group
...
> [!exercise] Inverse of a left coset in the quotient group
> Let $(G, \cdot)$ be a group, $H \subseteq G$ a **normal** subgroup of $G$ and $(G/H, \cdot)$ the quotient group.
...
> Let $\psi : G_1 \to G_2$ be a group homomorphism. Then the map
> $$\boxed{\overline{\psi} : G_1/\ker(\psi) \to \text{im}(\psi)}$$
> defined by
> $$\overline{\psi}(g \cdot \ker(\psi)) := \psi(g)$$
...
-   By Langrange's theorem (Theorem 4.3.3), we have$$[G_1 : \ker(\psi)] = \frac{|G_1|}{|\ker(\psi)|}.$$
